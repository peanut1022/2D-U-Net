...
class myAugmentation(object):	
	...
	"""
    def __init__(self, train_path="./images/train", label_path="./images/label", merge_path="merge", aug_merge_path="aug_merge", aug_train_path="aug_train", aug_label_path="aug_label", img_type="tif"):
        """
    ...
    def splitMerge(self):
        ...
        for i in range(self.slices):
            ...
            for imgname in train_imgs:
                ...
                img_label = img[:,:,0]
                print('save_train:', path_train+"/"+str(i)+"/"+midname+"_train"+"."+self.img_type)
                print('save_label:', path_label+"/"+str(i)+"/"+midname+"_label"+"."+self.img_type)
    ...
    def splitTransform(self):
        ...
        """
        path_merge = "./aug_merge"
        path_train = "./aug_train"
        path_label = "./aug_label"
        for i in range(self.slices):
            train_imgs = glob.glob(path_merge+"/"+str(i)+"/*."+self.img_type)
            ...
            for imgname in train_imgs:
                ...
                img_label = img[:,:,0]
                path = path_train+"/"+midname 
                print(path)
                cv2.imwrite(path_train+"/"+midname+"."+self.img_type,img_train)
                cv2.imwrite(path_label+"/"+midname+"."+self.img_type,img_label)

class dataProcess(object):
    def __init__(self, out_rows, out_cols, data_path = "./images/train", label_path = "./images/label", test_path = "./images/test", npy_path = "./npydata", img_type = "tif"):
         # 数据处理类，初始化
